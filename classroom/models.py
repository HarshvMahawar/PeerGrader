...
class QuestionsInAssignment(models.Model):
    ...
    question = models.ForeignKey(
        Question, related_name="assignments", on_delete=models.CASCADE
    )
    marks = (
        models.PositiveIntegerField()
    )  # Use this line to directly store marks in QuestionsInAssignment

    def __str__(self):
        return f"{self.assignment.assignment_name} - Question {self.question.question_number}"
