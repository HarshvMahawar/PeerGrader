...
urlpatterns = [
    ...
    path(
        "student/<int:pk>/marks_list",
        views.student_marks_list,
        name="student_marks_list",
    ),
    ...
    path(
        "teacher/class_students_list",
        views.class_students_list,
        name="class_student_list",
    ),
    path(
        "student/<int:pk>/all_marks",
        views.StudentAllMarksList.as_view(),
        name="all_marks_list",
    ),
    ...
    path(
        "update_assignment/<int:id>/", views.update_assignment, name="update_assignment"
    ),
    path(
        "assignment_delete/<int:id>/", views.assignment_delete, name="assignment_delete"
    ),
    path(
        "submit_assignment/<int:id>/", views.submit_assignment, name="submit_assignment"
    ),
