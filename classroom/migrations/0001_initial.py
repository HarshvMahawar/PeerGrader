    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "student_profile_pic",
                    models.ImageField(
                        blank=True, upload_to="classroom/student_profile_pic"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "teacher_profile_pic",
                    models.ImageField(
                        blank=True, upload_to="classroom/teacher_profile_pic"
                    ),
                ),
                (
                    "class_students",
                    models.ManyToManyField(
                        through="classroom.StudentsInClass", to="classroom.Student"
                    ),
                ),
            ],
        ),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="student_assignment", to="classroom.Student"
            ),
        ),
        migrations.AddField(
            model_name="classassignment",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "students",
                    models.ManyToManyField(
                        related_name="class_notice", to="classroom.Student"
                    ),
                ),
                (
                    "teacher",
