...
@login_required
def view_rubrics(request, assignment_id):
    assignment = get_object_or_404(ClassAssignment, pk=assignment_id)
    questions_in_assignment = QuestionsInAssignment.objects.filter(
        assignment=assignment
    )
    questions = []
    for question in questions_in_assignment:
        questions.append([question.question.question_number, question.marks])
    print(questions)
    context = {"assignment": assignment, "questions": questions}

    return render(request, "classroom/view_rubrics.html", context)
...
def StudentUpdateView(request, pk):
    ...
    return render(
        request,
        "classroom/student_update_page.html",
...
def TeacherUpdateView(request, pk):
    ...
    return render(
        request,
        "classroom/teacher_update_page.html",
        {"profile_updated": profile_updated, "form": form},
    )
...
def add_marks(request, pk):
    ...
    return render(
        ...
        {"form": form, "student": student, "marks_given": marks_given},
    )
...
def update_marks(request, pk):
    ...
    return render(
        request,
        "classroom/update_marks.html",
        {"form": form, "marks_updated": marks_updated},
    )
...
def add_notice(request):
    ...
    return render(
        request,
        "classroom/write_notice.html",
        {"notice": notice, "notice_sent": notice_sent},
    )
...
def student_marks_list(request, pk):
    ...
    return render(
        ...
        {"student": student, "given_marks": given_marks},
    )
...
def class_assignment(request):
    ...
    return render(
        ...
        {"student": student, "assignment_list": assignment_list},
    )
...
def submit_assignment(request, id=None):
    ...
    return render(
        request,
        "classroom/submit_assignment.html",
        {
            "form": form,
        },
    )
